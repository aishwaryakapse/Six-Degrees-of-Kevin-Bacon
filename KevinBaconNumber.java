...
public class KevinBaconNumber {
    ...
    public static void main(String[] args) {
      ...
      String filename = "C:\\Users\\ashka\\workspacejava\\SixDegreesOfKevinBacon\\src\\action06.txt"; // "cast.all.txt";
      String delimiter = "/";
      KevinBaconNumber kv;
        try {
            ...
            while(true){
                ...
                while(!(select >= 1 && select <=5)){
                    ...
                    System.out.println("2.Degree of sparation between any two actors/actrsses:");
